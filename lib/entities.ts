...
export const entityMetadata: Record<string, EntityMetadata> = {
  ...
  "invention-disclosure": {
    ...
    fields: [
      ...
      { name: "potential_clients", label: "Potential Clients", type: "textarea", required: false },
      { name: "research_area_ids", label: "Research Areas", type: "multiforeignkey", required: false, foreignEntity: "research-area" },
      ...
      { name: "contribution_percentage", label: "Contribution Percentage (per inventor)", type: "text", required: false },
      { name: "contribution_description", label: "Contribution Description (per inventor)", type: "textarea", required: false },
      { name: "applicants_ids_users", label: "Applicants (Users)", type: "multiforeignkey", required: false, foreignEntity: "user" },
      { name: "applicants_ids_entities", label: "Applicants (Entities)", type: "multiforeignkey", required: false, foreignEntity: "entity" },
    ],
    relationships: {
      parents: ["research"],
  ...
  "prior-art-search": {
    ...
    fields: [
      ...
      { name: "prior_art_report", label: "Prior Art Report", type: "file", required: true },
    ],
    relationships: {
  ...
  "patent-utility": {
    ...
    fields: [
      { name: "prior_art_search_id", label: "Prior Art Search", type: "foreignkey", required: true, foreignEntity: "prior-art-search" },
      ...
      { name: "cpc", label: "CPC Classification", type: "text", required: false },
      { name: "ipc", label: "IPC Classification", type: "text", required: true },
      { name: "abstract", label: "Abstract", type: "textarea", required: true },
      { name: "description", label: "Description", type: "textarea", required: true },
      { name: "claims", label: "Claims", type: "textarea", required: true },
      { name: "drawings", label: "Drawings", type: "multifile", required: true },
      { name: "original_document", label: "Original Document", type: "multifile", required: false },
      { name: "inventors_ids", label: "Inventors", type: "multiforeignkey", required: false, foreignEntity: "user" },
  ...
  "design-right": {
    ...
    fields: [
      ...
      { name: "prior_art_search_id", label: "Prior Art Search", type: "foreignkey", required: true, foreignEntity: "prior-art-search" },
      { name: "original_document", label: "Original Document", type: "multifile", required: true },
      { name: "inventors_ids", label: "Inventors", type: "multiforeignkey", required: false, foreignEntity: "user" },
      { name: "applicants_ids", label: "Applicants", type: "multiforeignkey", required: false, foreignEntity: "user" },
      { name: "applicants_percentage", label: "Applicants Percentage (per applicant)", type: "text", required: false },
    ],
    relationships: {
  ...
  license: {
    ...
    fields: [
      ...
      { name: "patent_utility_id", label: "Patent Utility", type: "foreignkey", required: false, foreignEntity: "patent-utility" },
      { name: "design_right_id", label: "Design Right", type: "foreignkey", required: false, foreignEntity: "design-right" },
      { name: "know_how_id", label: "Know-How", type: "foreignkey", required: false, foreignEntity: "know-how" },
      { name: "individual_licensor", label: "Individual Licensor", type: "foreignkey", required: false, foreignEntity: "user" },
      { name: "entity_licensor", label: "Entity Licensor", type: "foreignkey", required: false, foreignEntity: "entity" },
      { name: "licensee", label: "Licensee", type: "foreignkey", required: true, foreignEntity: "entity" },
      { name: "licensing_document", label: "Licensing Document", type: "file", required: true },
    ],
    relationships: {
  ...
  "tech-assessment": {
    ...
    fields: [
      ...
      { name: "trl_report", label: "TRL Report", type: "file", required: true },
    ],
    relationships: {
  ...
  "market-assessment": {
    ...
    fields: [
      ...
      { name: "market_assessment_report", label: "Market Assessment Report", type: "file", required: true },
    ],
    relationships: {
      parents: ["research", "prior-art-search", "patent-utility"],
      children: [],
  ...
  consultation: {
    ...
    fields: [
      ...
      { name: "research_id", label: "Research", type: "foreignkey", required: false, foreignEntity: "research" },
      { name: "contract", label: "Contract", type: "multifile", required: false },
      { name: "start_date", label: "Start Date", type: "date", required: false },
      { name: "end_date", label: "End Date", type: "date", required: false },
  ...
  fund: {
    ...
    fields: [
      ...
      { name: "terms_files", label: "Terms Files", type: "multifile", required: true },
  ...
  proposal: {
    ...
    fields: [
      ...
      { name: "entity_id", label: "Entity", type: "foreignkey", required: false, foreignEntity: "entity" },
      { name: "proposal_files", label: "Proposal Files", type: "multifile", required: false },
  ...
  "challenge-solution": {
    ...
    fields: [
      { name: "user_id", label: "User (Option 1)", type: "foreignkey", required: false, foreignEntity: "user" },
      { name: "entity_id", label: "Entity (Option 2)", type: "foreignkey", required: false, foreignEntity: "entity" },
      { name: "title", label: "Title", type: "text", required: true },
      ...
      { name: "associated_ip_patent", label: "Associated IP (Patent Utility)", type: "multiforeignkey", required: false, foreignEntity: "patent-utility" },
      { name: "associated_ip_design", label: "Associated IP (Design Right)", type: "multiforeignkey", required: false, foreignEntity: "design-right" },
      { name: "associated_ip_knowhow", label: "Associated IP (Know-How)", type: "multiforeignkey", required: false, foreignEntity: "know-how" },
    ],
    relationships: {
